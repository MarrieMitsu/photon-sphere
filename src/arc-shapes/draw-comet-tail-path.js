...
export default function drawCometTailPath(radius, width, margin, morphingShape, shape, startingDegree, endDegree) {
    let arc1, arc2;
    if (shape === ARCSHAPE.UNIFORM_IONTAIL) {
    ...
    } else if (shape === ARCSHAPE.UNIFORM_ANTITAIL) {
    ...
    */
    ...
    if (morphingShape) {
        ...
        C4 = PathCommand.cubicBezierCurve.C(arc1Start.point.x, arc1Start.point.y, arc1Start.point.x, arc1Start.point.y, arc1Start.point.x, arc1Start.point.y);
        ...
        if (shape === ARCSHAPE.UNIFORM_IONTAIL) {
            ...
            ZC3 = PathCommand.cubicBezierCurve.C(arc1Start.point.x, arc1Start.point.y, arc1Start.point.x, arc1Start.point.y, arc1Start.point.x, arc1Start.point.y);
        } else if (shape === ARCSHAPE.UNIFORM_ANTITAIL) {
            ...
            ZC3 = PathCommand.cubicBezierCurve.C(arc2End.point.x, arc2End.point.y, arc1Start.point.x, arc1Start.point.y, arc1Start.point.x, arc1Start.point.y);
        }
